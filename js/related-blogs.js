(() => {
  const posts = [
    { slug: 'how-visual-hierarchy-drives-user-attention', title: 'How Visual Hierarchy Drives User Attention', category: 'UX/UI Design', date: '23 Sep 26', image: '/assets/images/blogs/visual-hierarchy-user-attention-cover.webp', href: '/pages/blogs/how-visual-hierarchy-drives-user-attention.html', alt: 'Visual hierarchy guide showing a landing page with a clear call to action' },
    { slug: 'role-of-white-space-in-website-layouts', title: 'The Role of White Space in Website Layouts', category: 'UX/UI Design', date: '14 Sep 26', image: '/assets/images/blogs/white-space-website-layouts-cover.svg', href: '/pages/blogs/role-of-white-space-in-website-layouts.html', alt: 'Clean website interface surrounded by intentional white space' },
    { slug: 'how-to-design-accessible-websites-wcag-compliance', title: 'How to Design Accessible Websites for WCAG Compliance', category: 'Web Design', date: '12 Sep 26', image: '/assets/images/blogs/wcag-accessible-websites-cover.svg', href: '/pages/blogs/how-to-design-accessible-websites-wcag-compliance.html', alt: 'Accessible website design guide with WCAG compliance checklist' },
    { slug: 'gestalt-principles-modern-interface-design', title: 'Gestalt Principles in Modern Interface Design: 8 Laws for Clearer UX', category: 'UX/UI Design', date: '08 Sep 26', image: '/assets/images/blogs/gestalt-ui-design-thumbnail.png', href: '/pages/blogs/gestalt-principles-modern-interface-design.html', alt: 'Gestalt principles in modern interface design with visual grouping and hierarchy' },
    { slug: 'heuristic-evaluation-methods-for-web-apps', title: 'Heuristic Evaluation Methods for Web Apps: A Practical UX Review Framework', category: 'UX Research', date: '02 Sep 26', image: '/assets/images/blogs/heuristic-evaluation-methods-web-apps.png', href: '/pages/blogs/heuristic-evaluation-methods-for-web-apps.html', alt: 'Heuristic evaluation framework for improving web app usability' },
